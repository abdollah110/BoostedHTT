...
cp $RUNPATH/SkimerBoost.cc .
cp $RUNPATH/SkimerBoost.h .
cp $RUNPATH/Makefile .
...
############  Here is where the SkimerBoost is running     ############
do
...
############  Here is where the SkimerBoost ends          ############
...
rm skim*root  SkimerBoost.cc  SkimerBoost.h  Makefile  InputSamples.txt
echo "Done execution ..."
