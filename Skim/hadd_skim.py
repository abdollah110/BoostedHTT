...
parser.add_argument('-s','--skim',action='store',default='/eos/uscms/store/user/abdollah/SkimBoost/mm/v4',dest='skim', help='Location of the output file')
parser.add_argument('-n','--name',action='store',default='v1',dest='name', help='Location of the output file')
