...
python train.py --signal JJH125 --background NonDY --background2 ZTT --input datasets/Training_${version}_${year}.h5 --category vbf --year ${year} --model outputModel_${version}_${year}
