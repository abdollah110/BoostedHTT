...
parser.add_argument('-i','--input',action='store',default='/store/user/abdollah/NewSkimBoost/mt/v2',dest='Input', help='Location of the Input file')
args = parser.parse_args()


os.system("find {} > InputSamples_sv.txt".format(args.Input))
...
input_File=open('InputSamples_sv.txt','r')
count=0
...
#exeLocation = sp.getInput('which %s'%args.exe)
...
os.system('mv InputSamples_sv.txt Files_%s/.'%(args.Name))
