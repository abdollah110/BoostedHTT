...
// Fri Jan 12 18:54:15 2024 by ROOT version 6.12/07
// from TTree tautau_tree/Event data (tag V10_02_10_04)
// found on file: /eos/uscms//store/user/abdollah/SkimBoostedH2/2017/hpstt/v1_Hadd/GluGluHToTauTau_M125_v1.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *taudz;
   vector<float>   *taudxy;
   vector<float>   *tauByDeepTau2017v1VSjetraw;
   vector<float>   *tauByDeepTau2017v1VSeraw;
   vector<float>   *tauByDeepTau2017v1VSmuraw;
   vector<bool>    *taubyVVVLooseDeepTau2017v1VSjet;
   vector<bool>    *taubyVLooseDeepTau2017v1VSjet;
   vector<bool>    *taubyLooseDeepTau2017v1VSjet;
   vector<bool>    *taubyMediumDeepTau2017v1VSjet;
   vector<bool>    *taubyTightDeepTau2017v1VSjet;
   vector<bool>    *taubyVVTightDeepTau2017v1VSjet;
   vector<bool>    *taubyVVVLooseDeepTau2017v1VSe;
   vector<bool>    *taubyLooseDeepTau2017v1VSe;
   vector<bool>    *taubyTightDeepTau2017v1VSe;
   vector<bool>    *taubyVVVLooseDeepTau2017v1VSmu;
   vector<bool>    *taubyLooseDeepTau2017v1VSmu;
   vector<bool>    *taubyTightDeepTau2017v1VSmu;
   Int_t           nJet;
   vector<float>   *jetPt;
   ...
   TBranch        *b_taudz;   //!
   TBranch        *b_taudxy;   //!
   TBranch        *b_tauByDeepTau2017v1VSjetraw;   //!
   TBranch        *b_tauByDeepTau2017v1VSeraw;   //!
   TBranch        *b_tauByDeepTau2017v1VSmuraw;   //!
   TBranch        *b_taubyVVVLooseDeepTau2017v1VSjet;   //!
   TBranch        *b_taubyVLooseDeepTau2017v1VSjet;   //!
   TBranch        *b_taubyLooseDeepTau2017v1VSjet;   //!
   TBranch        *b_taubyMediumDeepTau2017v1VSjet;   //!
   TBranch        *b_taubyTightDeepTau2017v1VSjet;   //!
   TBranch        *b_taubyVVTightDeepTau2017v1VSjet;   //!
   TBranch        *b_taubyVVVLooseDeepTau2017v1VSe;   //!
   TBranch        *b_taubyLooseDeepTau2017v1VSe;   //!
   TBranch        *b_taubyTightDeepTau2017v1VSe;   //!
   TBranch        *b_taubyVVVLooseDeepTau2017v1VSmu;   //!
   TBranch        *b_taubyLooseDeepTau2017v1VSmu;   //!
   TBranch        *b_taubyTightDeepTau2017v1VSmu;   //!
   TBranch        *b_nJet;   //!
   TBranch        *b_jetPt;   //!
...
//
//#ifdef hpstau_cxx
//hpstau::hpstau(TTree *tree) : fChain(0) 
//{
//// if parameter tree is not specified (or zero), connect the file
//// used to generate this class and read the Tree.
//   if (tree == 0) {
//      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms//store/user/abdollah/SkimBoostedH2/2017/hpstt/v1_Hadd/GluGluHToTauTau_M125_v1.root");
//      if (!f || !f->IsOpen()) {
//         f = new TFile("/eos/uscms//store/user/abdollah/SkimBoostedH2/2017/hpstt/v1_Hadd/GluGluHToTauTau_M125_v1.root");
//      }
//      f->GetObject("tautau_tree",tree);
//
//   }
//   Init(tree);
//}
...
//}
//
//Int_t hpstau::GetEntry(Long64_t entry)
//{
//// Read contents of entry.
//   if (!fChain) return 0;
//   return fChain->GetEntry(entry);
//}
//Long64_t hpstau::LoadTree(Long64_t entry)
//{
...
//   taudz = 0;
//   taudxy = 0;
//   tauByDeepTau2017v1VSjetraw = 0;
//   tauByDeepTau2017v1VSeraw = 0;
//   tauByDeepTau2017v1VSmuraw = 0;
//   taubyVVVLooseDeepTau2017v1VSjet = 0;
//   taubyVLooseDeepTau2017v1VSjet = 0;
//   taubyLooseDeepTau2017v1VSjet = 0;
//   taubyMediumDeepTau2017v1VSjet = 0;
//   taubyTightDeepTau2017v1VSjet = 0;
//   taubyVVTightDeepTau2017v1VSjet = 0;
//   taubyVVVLooseDeepTau2017v1VSe = 0;
//   taubyLooseDeepTau2017v1VSe = 0;
//   taubyTightDeepTau2017v1VSe = 0;
//   taubyVVVLooseDeepTau2017v1VSmu = 0;
//   taubyLooseDeepTau2017v1VSmu = 0;
//   taubyTightDeepTau2017v1VSmu = 0;
//   jetPt = 0;
//   jetPtTotUncUp = 0;
//   jetPtTotUncDown = 0;
//   jetEn = 0;
...
//   
   ...
   fChain->SetBranchAddress("taudxy", &taudxy, &b_taudxy);
   fChain->SetBranchAddress("tauByDeepTau2017v1VSjetraw", &tauByDeepTau2017v1VSjetraw, &b_tauByDeepTau2017v1VSjetraw);
   fChain->SetBranchAddress("tauByDeepTau2017v1VSeraw", &tauByDeepTau2017v1VSeraw, &b_tauByDeepTau2017v1VSeraw);
   fChain->SetBranchAddress("tauByDeepTau2017v1VSmuraw", &tauByDeepTau2017v1VSmuraw, &b_tauByDeepTau2017v1VSmuraw);
   fChain->SetBranchAddress("taubyVVVLooseDeepTau2017v1VSjet", &taubyVVVLooseDeepTau2017v1VSjet, &b_taubyVVVLooseDeepTau2017v1VSjet);
   fChain->SetBranchAddress("taubyVLooseDeepTau2017v1VSjet", &taubyVLooseDeepTau2017v1VSjet, &b_taubyVLooseDeepTau2017v1VSjet);
   fChain->SetBranchAddress("taubyLooseDeepTau2017v1VSjet", &taubyLooseDeepTau2017v1VSjet, &b_taubyLooseDeepTau2017v1VSjet);
   fChain->SetBranchAddress("taubyMediumDeepTau2017v1VSjet", &taubyMediumDeepTau2017v1VSjet, &b_taubyMediumDeepTau2017v1VSjet);
   fChain->SetBranchAddress("taubyTightDeepTau2017v1VSjet", &taubyTightDeepTau2017v1VSjet, &b_taubyTightDeepTau2017v1VSjet);
   fChain->SetBranchAddress("taubyVVTightDeepTau2017v1VSjet", &taubyVVTightDeepTau2017v1VSjet, &b_taubyVVTightDeepTau2017v1VSjet);
   fChain->SetBranchAddress("taubyVVVLooseDeepTau2017v1VSe", &taubyVVVLooseDeepTau2017v1VSe, &b_taubyVVVLooseDeepTau2017v1VSe);
   fChain->SetBranchAddress("taubyLooseDeepTau2017v1VSe", &taubyLooseDeepTau2017v1VSe, &b_taubyLooseDeepTau2017v1VSe);
   fChain->SetBranchAddress("taubyTightDeepTau2017v1VSe", &taubyTightDeepTau2017v1VSe, &b_taubyTightDeepTau2017v1VSe);
   fChain->SetBranchAddress("taubyVVVLooseDeepTau2017v1VSmu", &taubyVVVLooseDeepTau2017v1VSmu, &b_taubyVVVLooseDeepTau2017v1VSmu);
   fChain->SetBranchAddress("taubyLooseDeepTau2017v1VSmu", &taubyLooseDeepTau2017v1VSmu, &b_taubyLooseDeepTau2017v1VSmu);
   fChain->SetBranchAddress("taubyTightDeepTau2017v1VSmu", &taubyTightDeepTau2017v1VSmu, &b_taubyTightDeepTau2017v1VSmu);
   ...
   fChain->SetBranchAddress("decayMode1", &decayMode1, &b_decayMode1);
...
//}
//
//void hpstau::Show(Long64_t entry)
//{
...
//   fChain->Show(entry);
//}
//Int_t hpstau::Cut(Long64_t entry)
//{
