...
float getTriggerWeight(int year, bool isData,  float AK8JetPt , float AK8JetSoftDropMass , TH2F * triggerEff){
    ...
    if (AK8JetSoftDropMass > 299)  AK8JetSoftDropMass= 299;
        weight = triggerEff->GetBinContent(triggerEff->GetXaxis()->FindBin(AK8JetPt), triggerEff->GetYaxis()->FindBin(AK8JetSoftDropMass));
        return weight;
    }
    return weight;
}
