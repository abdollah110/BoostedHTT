...
#       for j in range(1,ggH_count.GetSize()-1):
       for j in range(4,5):
         ...
         xs[0]=xs[0]+ggH_count.GetBinContent(j)*file.Get(variable[k]+"_nnlops").Get("ggH_htt125").GetEntries()/file.Get("Events").Get("ggH_htt125").GetBinContent(1)*10
         xs[0]=xs[0]+file.Get(variable[k]+"_powheg").Get("qqH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("qqH_htt125").GetEntries()/file.Get("Events").Get("qqH_htt125").GetBinContent(1)*10
         xs[0]=xs[0]+file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125").GetEntries()/file.Get("Events").Get("ggZH_lep_htt125").GetBinContent(1)*10
         xs[0]=xs[0]+file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125").GetEntries()/file.Get("Events").Get("ggZH_had_htt125").GetBinContent(1)*10
         xs[0]=xs[0]+file.Get(variable[k]+"_powheg").Get("WH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("WH_htt125").GetEntries()/file.Get("Events").Get("WH_htt125").GetBinContent(1)*10
         xs[0]=xs[0]+file.Get(variable[k]+"_powheg").Get("ZH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ZH_htt125").GetEntries()/file.Get("Events").Get("ZH_htt125").GetBinContent(1)*10
         xs[0]=xs[0]+file.Get(variable[k]+"_powheg").Get("ttH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ttH_htt125").GetEntries()/file.Get("Events").Get("ttH_htt125").GetBinContent(1)*10
         for z in range(0,9):
            xs[z+1]=xs[z+1]+file.Get(variable[k]+"_nnlops").Get("ggH_htt125"+postfix[z]).GetBinContent(j)*file.Get(variable[k]+"_nnlops").Get("ggH_htt125").GetEntries()/file.Get("Events").Get("ggH_htt125").GetBinContent(1)*10
            xs[z+1]=xs[z+1]+file.Get(variable[k]+"_powheg").Get("qqH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("qqH_htt125").GetEntries()/file.Get("Events").Get("qqH_htt125").GetBinContent(1)*10
            xs[z+1]=xs[z+1]+file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125").GetEntries()/file.Get("Events").Get("ggZH_lep_htt125").GetBinContent(1)*10
            xs[z+1]=xs[z+1]+file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125").GetEntries()/file.Get("Events").Get("ggZH_had_htt125").GetBinContent(1)*10
            xs[z+1]=xs[z+1]+file.Get(variable[k]+"_powheg").Get("WH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("WH_htt125").GetEntries()/file.Get("Events").Get("WH_htt125").GetBinContent(1)*10
            xs[z+1]=xs[z+1]+file.Get(variable[k]+"_powheg").Get("ZH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ZH_htt125").GetEntries()/file.Get("Events").Get("ZH_htt125").GetBinContent(1)*10
            xs[z+1]=xs[z+1]+file.Get(variable[k]+"_powheg").Get("ttH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ttH_htt125").GetEntries()/file.Get("Events").Get("ttH_htt125").GetBinContent(1)*10

         xs[10]=xs[10]+ggH_count.GetBinContent(j)*file.Get(variable[k]+"_nnlops").Get("ggH_htt125").GetEntries()/file.Get("Events").Get("ggH_htt125").GetBinContent(1)*10
         print '  hi here is x10 ',xs[10]
         xs[10]=xs[10]+file.Get(variable[k]+"_powheg").Get("qqH_htt125_scale").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("qqH_htt125").GetEntries()/file.Get("Events").Get("qqH_htt125").GetBinContent(1)*10
         xs[10]=xs[10]+file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125").GetEntries()/file.Get("Events").Get("ggZH_lep_htt125").GetBinContent(1)*10
         xs[10]=xs[10]+file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125").GetEntries()/file.Get("Events").Get("ggZH_had_htt125").GetBinContent(1)*10
         xs[10]=xs[10]+file.Get(variable[k]+"_powheg").Get("WH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("WH_htt125").GetEntries()/file.Get("Events").Get("WH_htt125").GetBinContent(1)*10
         xs[10]=xs[10]+file.Get(variable[k]+"_powheg").Get("ZH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ZH_htt125").GetEntries()/file.Get("Events").Get("ZH_htt125").GetBinContent(1)*10
         xs[10]=xs[10]+file.Get(variable[k]+"_powheg").Get("ttH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ttH_htt125").GetEntries()/file.Get("Events").Get("ttH_htt125").GetBinContent(1)*10

         xs[11]=xs[11]+ggH_count.GetBinContent(j)*file.Get(variable[k]+"_nnlops").Get("ggH_htt125").GetEntries()/file.Get("Events").Get("ggH_htt125").GetBinContent(1)*10
         xs[11]=xs[11]+file.Get(variable[k]+"_powheg").Get("qqH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("qqH_htt125").GetEntries()/file.Get("Events").Get("qqH_htt125").GetBinContent(1)*10
         xs[11]=xs[11]+file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125").GetEntries()/file.Get("Events").Get("ggZH_lep_htt125").GetBinContent(1)*10
         xs[11]=xs[11]+file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125").GetEntries()/file.Get("Events").Get("ggZH_had_htt125").GetBinContent(1)*10
         xs[11]=xs[11]+file.Get(variable[k]+"_powheg").Get("WH_htt125_scale").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("WH_htt125").GetEntries()/file.Get("Events").Get("WH_htt125").GetBinContent(1)*10
         xs[11]=xs[11]+file.Get(variable[k]+"_powheg").Get("ZH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ZH_htt125").GetEntries()/file.Get("Events").Get("ZH_htt125").GetBinContent(1)*10
         xs[11]=xs[11]+file.Get(variable[k]+"_powheg").Get("ttH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ttH_htt125").GetEntries()/file.Get("Events").Get("ttH_htt125").GetBinContent(1)*10

         xs[12]=xs[12]+ggH_count.GetBinContent(j)*file.Get(variable[k]+"_nnlops").Get("ggH_htt125").GetEntries()/file.Get("Events").Get("ggH_htt125").GetBinContent(1)*10
         xs[12]=xs[12]+file.Get(variable[k]+"_powheg").Get("qqH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("qqH_htt125").GetEntries()/file.Get("Events").Get("qqH_htt125").GetBinContent(1)*10
         xs[12]=xs[12]+file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125_scale").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125").GetEntries()/file.Get("Events").Get("ggZH_lep_htt125").GetBinContent(1)*10
         xs[12]=xs[12]+file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125_scale").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125").GetEntries()/file.Get("Events").Get("ggZH_had_htt125").GetBinContent(1)*10
         xs[12]=xs[12]+file.Get(variable[k]+"_powheg").Get("WH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("WH_htt125").GetEntries()/file.Get("Events").Get("WH_htt125").GetBinContent(1)*10
         xs[12]=xs[12]+file.Get(variable[k]+"_powheg").Get("ZH_htt125_scale").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ZH_htt125").GetEntries()/file.Get("Events").Get("ZH_htt125").GetBinContent(1)*10
         xs[12]=xs[12]+file.Get(variable[k]+"_powheg").Get("ttH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ttH_htt125").GetEntries()/file.Get("Events").Get("ttH_htt125").GetBinContent(1)*10

         xs[13]=xs[13]+ggH_count.GetBinContent(j)*file.Get(variable[k]+"_nnlops").Get("ggH_htt125").GetEntries()/file.Get("Events").Get("ggH_htt125").GetBinContent(1)*10
         xs[13]=xs[13]+file.Get(variable[k]+"_powheg").Get("qqH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("qqH_htt125").GetEntries()/file.Get("Events").Get("qqH_htt125").GetBinContent(1)*10
         xs[13]=xs[13]+file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_lep_htt125").GetEntries()/file.Get("Events").Get("ggZH_lep_htt125").GetBinContent(1)*10
         xs[13]=xs[13]+file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ggZH_had_htt125").GetEntries()/file.Get("Events").Get("ggZH_had_htt125").GetBinContent(1)*10
         xs[13]=xs[13]+file.Get(variable[k]+"_powheg").Get("WH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("WH_htt125").GetEntries()/file.Get("Events").Get("WH_htt125").GetBinContent(1)*10
         xs[13]=xs[13]+file.Get(variable[k]+"_powheg").Get("ZH_htt125").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ZH_htt125").GetEntries()/file.Get("Events").Get("ZH_htt125").GetBinContent(1)*10
         xs[13]=xs[13]+file.Get(variable[k]+"_powheg").Get("ttH_htt125_scale").GetBinContent(j)*file.Get(variable[k]+"_powheg").Get("ttH_htt125").GetEntries()/file.Get("Events").Get("ttH_htt125").GetBinContent(1)*10
    ...
    #     XH_tt.SetBinContent(j+1,XH_tt.GetBinContent(j+1)*1000/width)
       ...
       if k==0: ggH_powheg.SetMaximum(20*ggH_powheg.GetMaximum())
    ...
    #      print "njets tt: ",ggH_nnlops_tt.GetBinContent(1)*ggH_nnlops_tt.GetBinWidth(1),ggH_nnlops_tt.GetBinContent(2)*ggH_nnlops_tt.GetBinWidth(2),ggH_nnlops_tt.GetBinContent(3)*ggH_nnlops_tt.GetBinWidth(3),ggH_nnlops_tt.GetBinContent(4)*ggH_nnlops_tt.GetBinWidth(4),ggH_nnlops_tt.GetBinContent(5)*ggH_nnlops_tt.GetBinWidth(5)
       ...
       if k==1: trFile=ROOT.TFile(args.JetPtLimit,'read')
       ...
       trName=trFile.Get('limit')
       for tr in trName:
           ListOfLimit_0_350.append(trName.r_H_PTH_0_350)
           ListOfLimit_350_450.append(trName.r_H_PTH_350_450)
           ListOfLimit_450_600.append(trName.r_H_PTH_450_600)
           ListOfLimit_600_800.append(trName.r_H_PTH_600_800)
           ListOfLimit_GT800.append(trName.r_H_PTH_GT800)
       ...
       ListOfLimit_All.append(ListOfLimit_600_800)
       ListOfLimit_All.append(ListOfLimit_GT800)

       print ListOfLimit_0_350[0], ListOfLimit_0_350[1], ListOfLimit_0_350[2], ListOfLimit_0_350[3], ListOfLimit_0_350[4]
       print ListOfLimit_All[0][0], ListOfLimit_All[0][1], ListOfLimit_All[0][2], ListOfLimit_All[0][3], ListOfLimit_All[0][4]


       if k==0:#HpT
          xList = [300,400,525,700,1400]
          xhighList = [50,50,75,100,600]
          xlowList = [50,50,75,100,600]
    ...
    #               2.00 * ggH_nnlops.GetBinContent(7)
          ...
          ylowList = [
                   (ListOfLimit_All[0][0]- ListOfLimit_All[0][1]) * ggH_nnlops.GetBinContent(1),
                   (ListOfLimit_All[1][0]- ListOfLimit_All[1][1]) * ggH_nnlops.GetBinContent(2),
                   (ListOfLimit_All[2][0]- ListOfLimit_All[2][1]) * ggH_nnlops.GetBinContent(3),
                   (ListOfLimit_All[3][0]- ListOfLimit_All[3][1]) * ggH_nnlops.GetBinContent(4),
                   (ListOfLimit_All[4][0]- ListOfLimit_All[4][1]) * ggH_nnlops.GetBinContent(5),
    #               1.68 * ggH_nnlops.GetBinContent(6),
    #               2.00 * ggH_nnlops.GetBinContent(7)
          ]
          yhighList =[
          
                   (-ListOfLimit_All[0][0]+ ListOfLimit_All[0][2]) * ggH_nnlops.GetBinContent(1),
                   (-ListOfLimit_All[1][0]+ ListOfLimit_All[1][2]) * ggH_nnlops.GetBinContent(2),
                   (-ListOfLimit_All[2][0]+ ListOfLimit_All[2][2]) * ggH_nnlops.GetBinContent(3),
                   (-ListOfLimit_All[3][0]+ ListOfLimit_All[3][2]) * ggH_nnlops.GetBinContent(4),
    ...
    #      ]
       ...
       if k==1:#j1pt
          xList = [150,350,475,675,1400]
          xhighList = [150,50,75,125,600]
          xlowList = [150,50,75,125,600]
...
#       Data2.Draw("EP0SAME")
       ...
       c.Modified()
       c.SaveAs("differential_"+args.OutName+"_"+variable[k]+"_blind.pdf")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--HiggsPtLimit', '-g', required=True, help='Higgs Combine outcome of higgs pT')
