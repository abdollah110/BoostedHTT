...
int main(int argc, char** argv) {
    ...
    ("Diff", po::value<string>(&Diff)->default_value(""))
...
//    bkg_procs["em_ztt"] = {"QCD","W", "TT","VV","ZTT"};
...
//    VString sig_procs = {"ggH_"+Diff+"_0_350","ggH_"+Diff+"_350_450","ggH_"+Diff+"_450_600","ggH_"+Diff+"_GT600","XH_"+Diff+"_0_350","XH_"+Diff+"_350_450","XH_"+Diff+"_450_600","XH_"+Diff+"_GT600","OutsideAcceptance"};
    VString sig_procs = {"ggH_"+Diff+"_0_350","ggH_"+Diff+"_350_450","ggH_"+Diff+"_450_600","ggH_"+Diff+"_GT600","XH_"+Diff+"_0_350","XH_"+Diff+"_350_450","XH_"+Diff+"_450_600","XH_"+Diff+"_GT600"};
    VString ggH_procs = {"ggH_"+Diff+"_0_350","ggH_"+Diff+"_350_450","ggH_"+Diff+"_450_600","ggH_"+Diff+"_GT600"};
//    VString sig_procs = {"ggH_"+Diff+"_0_350","XH_"+Diff+"_0_350"};
//    VString ggH_procs = {"ggH_"+Diff+"_0_350"};
//
    map<string, VString> bkg_procs;
    bkg_procs["mt_qcd"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance"};
    bkg_procs["mt_signal"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance"};
    bkg_procs["mt_ztt"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance"};
    bkg_procs["et_qcd"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance"};
    bkg_procs["et_signal"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance"};
    bkg_procs["et_ztt"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance"};
    bkg_procs["tt_qcd"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance"};
    bkg_procs["tt_signal"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance"};
    bkg_procs["tt_ztt"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance"};
    bkg_procs["em_qcd"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance","W"};
    bkg_procs["em_signal"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance","W"};
    bkg_procs["em_ztt"] = {"QCD", "TT","VV","ZTT" ,"OutsideAcceptance","W"};
//
//
//    VString sig_procs = {"ggH","XH"};
    ...
    cats["mt_qcd"] = {
        {1, "Htt_"+Diff+"_GT600_cat"+year+"mt_qcd"},
    };
    cats["mt_signal"] = {
        {1, "Htt_"+Diff+"_0_350_cat"+year+"mt_signal"},
        {2, "Htt_"+Diff+"_350_450_cat"+year+"mt_signal"},
        {3, "Htt_"+Diff+"_450_600_cat"+year+"mt_signal"},
        {4, "Htt_"+Diff+"_GT600_cat"+year+"mt_signal"},
    };
    cats["mt_ztt"] = {
        {1, "Htt_"+Diff+"_GT600_cat"+year+"mt_ztt"},
    };
    cats["et_qcd"] = {
        {1, "Htt_"+Diff+"_GT600_cat"+year+"et_qcd"},
    };
    cats["et_signal"] = {
        {1, "Htt_"+Diff+"_0_350_cat"+year+"et_signal"},
        {2, "Htt_"+Diff+"_350_450_cat"+year+"et_signal"},
        {3, "Htt_"+Diff+"_450_600_cat"+year+"et_signal"},
        {4, "Htt_"+Diff+"_GT600_cat"+year+"et_signal"},
    };
    cats["et_ztt"] = {
        {1, "Htt_"+Diff+"_GT600_cat"+year+"et_ztt"},
    };
    cats["tt_qcd"] = {
        {1, "Htt_"+Diff+"_GT600_cat"+year+"tt_qcd"},
    };
    cats["tt_signal"] = {
        {1, "Htt_"+Diff+"_0_350_cat"+year+"tt_signal"},
        {2, "Htt_"+Diff+"_350_450_cat"+year+"tt_signal"},
        {3, "Htt_"+Diff+"_450_600_cat"+year+"tt_signal"},
        {4, "Htt_"+Diff+"_GT600_cat"+year+"tt_signal"},
    };
    cats["tt_ztt"] = {
        {1, "Htt_"+Diff+"_GT600_cat"+year+"tt_ztt"},
    };
    cats["em_qcd"] = {
        {1, "Htt_"+Diff+"_GT600_cat"+year+"em_qcd"},
    };
    cats["em_signal"] = {
        {1, "Htt_"+Diff+"_0_350_cat"+year+"em_signal"},
        {2, "Htt_"+Diff+"_350_450_cat"+year+"em_signal"},
        {3, "Htt_"+Diff+"_450_600_cat"+year+"em_signal"},
        {4, "Htt_"+Diff+"_GT600_cat"+year+"em_signal"},
    };
    cats["em_ztt"] = {
        {1, "Htt_"+Diff+"_GT600_cat"+year+"em_ztt"},
    };
    ...
    vector<string> BinNames = {"_bin1","_bin2","_bin3","_bin4"};
...
//        if ( chn.find("signal") != string::npos)
   ...
   // QCD norm uncertainties decorrelated across years channel and categories
    ...
    //        .AddSyst(cb, "CMS_scale_j_catsignal"+year, "shape", SystMap<>::init(1.00));
    //
    ...
    cb.cp().process({"QCD"}).channel({"tt_signal"})
        .AddSyst(cb, "CMS_QCD_bkg_modeling_tt_catsignal"+year, "shape", SystMap<>::init(1.00));
    cb.cp().process({"QCD"}).channel({"et_signal"})
        .AddSyst(cb, "CMS_QCD_bkg_modeling_et_catsignal"+year, "shape", SystMap<>::init(1.00));
    cb.cp().process({"QCD"}).channel({"mt_signal"})
        .AddSyst(cb, "CMS_QCD_bkg_modeling_mt_catsignal"+year, "shape", SystMap<>::init(1.00));
    cb.cp().process({"QCD"}).channel({"em_signal"})
        .AddSyst(cb, "CMS_QCD_bkg_modeling_em_catsignal"+year, "shape", SystMap<>::init(1.00));
...
//        .AddSyst(cb, "TTQCDScale"+year, "shape", SystMap<>::init(1.00));
    ...
    cb.cp().process({"ZTT"}).channel(ch::JoinStr({sig_cat}))
        .AddSyst(cb, "ZTTQCDScale_catsignal"+year, "shape", SystMap<>::init(1.00));
    cb.cp().process({"TT"}).channel(ch::JoinStr({sig_cat}))
        .AddSyst(cb, "TTQCDScale_catsignal"+year, "shape", SystMap<>::init(1.00));
