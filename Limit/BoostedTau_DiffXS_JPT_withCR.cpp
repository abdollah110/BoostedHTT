...
//    VString sig_procs = {"ggH_PTJ_0_450","ggH_PTJ_450_600","ggH_PTJ_GT600","XH_PTJ_0_450","XH_PTJ_450_600","XH_PTJ_GT600"};
//    VString ggH_procs = {"ggH_PTJ_0_450","ggH_PTJ_450_600","ggH_PTJ_GT600"};
//    VString sig_procs = {"ggH_PTJ_450_600","ggH_PTJ_GT600","XH_PTJ_450_600","XH_PTJ_GT600"};
//    VString ggH_procs = {"ggH_PTJ_450_600","ggH_PTJ_GT600"};
...
//    VString sig_procs = {"H125"};
    ...
    cats["mt"] = {
        {1, "Htt_PTJ_0_350_cat"+year+"mt_signal"},
        {2, "Htt_PTJ_350_450_cat"+year+"mt_signal"},
        {3, "Htt_PTJ_450_600_cat"+year+"mt_signal"},
        {4, "Htt_PTJ_GT600_cat"+year+"mt_signal"},

    };
    cats["mt_bkg"] = {
        {1, "Htt_PTJ_GT600_cat"+year+"mt_ztt"},
        {2, "Htt_PTJ_GT600_cat"+year+"mt_qcd"},
    };

    cats["et"] = {
        {1, "Htt_PTJ_0_350_cat"+year+"et_signal"},
        {2, "Htt_PTJ_350_450_cat"+year+"et_signal"},
        {3, "Htt_PTJ_450_600_cat"+year+"et_signal"},
        {4, "Htt_PTJ_GT600_cat"+year+"et_signal"},
    };
    cats["et_bkg"] = {
        {1, "Htt_PTJ_GT600_cat"+year+"et_ztt"},
        {2, "Htt_PTJ_GT600_cat"+year+"et_qcd"},
    };

    cats["tt"] = {
        {1, "Htt_PTJ_0_350_cat"+year+"tt_signal"},
        {2, "Htt_PTJ_350_450_cat"+year+"tt_signal"},
        {3, "Htt_PTJ_450_600_cat"+year+"tt_signal"},
        {4, "Htt_PTJ_GT600_cat"+year+"tt_signal"},
    };
    cats["tt_bkg"] = {
        {1, "Htt_PTJ_GT600_cat"+year+"tt_ztt"},
        {2, "Htt_PTJ_GT600_cat"+year+"tt_qcd"},
    };

    cats["em"] = {
        {1, "Htt_PTJ_0_350_cat"+year+"em_signal"},
        {2, "Htt_PTJ_350_450_cat"+year+"em_signal"},
        {3, "Htt_PTJ_450_600_cat"+year+"em_signal"},
        {4, "Htt_PTJ_GT600_cat"+year+"em_signal"},
    };
    cats["em_bkg"] = {
        {1, "Htt_PTJ_GT600_cat"+year+"em_ztt"},
        {2, "Htt_PTJ_GT600_cat"+year+"em_qcd"},
    };
    ...
    for (auto chn : chns) {
        ...
        if ( chn.find("bkg") == string::npos)  cb.AddProcesses(
