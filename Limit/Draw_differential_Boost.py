...
#   r_H_PTH_450_600 :    +3.559   -1.537/+1.580 (68%)
#   r_H_PTH_350_450 :    -1.564   -1.501/+1.519 (68%)
#     r_H_PTH_0_350 :    +1.345   -1.162/+1.274 (68%)
#     r_H_PTH_GT600 :    -3.637   -1.392/+1.697 (68%)
...
#
   ...
   trFile=ROOT.TFile('higgsCombinetest_param0.MultiDimFit.mH125_hpt.root','read')
   if k==1: trFile=ROOT.TFile('higgsCombinetest_param0.MultiDimFit.mH125_jpt.root','read')
   ...
   for tr in trName:
       ListOfLimit_0_300.append(trName.r_H_PTH_0_300)
       ListOfLimit_300_400.append(trName.r_H_PTH_300_400)
       ListOfLimit_400_550.append(trName.r_H_PTH_400_550)
       ListOfLimit_550_800.append(trName.r_H_PTH_550_800)
       ListOfLimit_GT800.append(trName.r_H_PTH_GT800)
        
   trFile.Close()

   ListOfLimit_All=[]
   ListOfLimit_All.append(ListOfLimit_0_300)
   ListOfLimit_All.append(ListOfLimit_300_400)
   ListOfLimit_All.append(ListOfLimit_400_550)
   ListOfLimit_All.append(ListOfLimit_550_800)
   ListOfLimit_All.append(ListOfLimit_GT800)

   print ListOfLimit_0_300[0], ListOfLimit_0_300[1], ListOfLimit_0_300[2], ListOfLimit_0_300[3], ListOfLimit_0_300[4]
...
#   Data2.Draw("EP0SAME")
   ...
   c.Modified()
   c.SaveAs("differential_v3_"+variable[k]+"_blind.pdf")
