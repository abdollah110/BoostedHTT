...
def add_CMS():
    ...
    lumi.SetTextColor(    1 )
    lumi.AddText("CMS Simulation 2017")
    return lumi


def MakeCompare(root1,hist1,name1,hist2, name2,Name,Sample, XTiltle):
...
#    h5.Draw("same")
    ...
    c.SaveAs('_ShapeCompare_2017_%s_%s.pdf'%(Name,Sample))
...
for var in Variable:
    ...
    MakeCompare('Output/templates/et2017_%s.root'%var[0],'et_0jet/H125','H125','et_0jet/JJH125','JJH125',var[0],'etau',var[1])
    MakeCompare('Output/templates/mt2017_%s.root'%var[0],'mt_0jet/H125','H125','mt_0jet/JJH125','JJH125',var[0],'mutau',var[1])
