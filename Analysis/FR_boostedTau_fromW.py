...
#
    ...
    numHistRB.Draw()
    can.SaveAs('fr_{}_{}_new_pt_TT.pdf'.format(num,year))
    can.SaveAs('fr_{}_{}_new_pt_TT.root'.format(num,year))
    OutRoot=TFile('File_fr_{}_{}_new_pt_TT.root'.format(num,year),'RECREATE')
    numHistRB.Write()
    OutRoot.Close()
