...
def MakePlot(FileName,categoriy,HistName,Xaxis,Info,RB_,channel,yMin,isLOG,ttbarCR):
#    yMin*=0.1
...
for i in range(0,len(FileNamesInfo)):
    ...
    for isLOG in logStat:
        for reg in region:
            ...
            FileName="Fake_"+NormMC+reg[0]+".root"
            Info=NormMC+reg[0]
            print "---->", FileName
            MakePlot(FileName,reg[1],"",axisName,Info,Bin,"",yMin,isLOG,reg[0])
