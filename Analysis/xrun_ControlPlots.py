...
#        if Observable==var[0]:
        ...
        print 'command is ' , './{} -d {}   --suf {} -v {} -b {} {} {} '.format(executable, InputFile, prefix, var[0],var[1],var[2],var[3])
        os.system('./{} -d {}   --suf {} -v {} -b {} {} {} '.format(executable, InputFile, prefix, var[0],var[1],var[2],var[3]))
#        break
