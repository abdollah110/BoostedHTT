...
#include "../interface/process_trees_NN_Z.h"
...
//        if (name.find("Up") !=string::npos || name.find("Down") !=string::npos ) continue;
        ...
        for (auto i = 0; i < tree->GetEntries(); i++) {
            ...
            float preFitUncUp=1.5;
            float preFitUncDown=0.5;

            if (runTauId.find("TauIdBin_1_Up") != string::npos && (higgs_pT> 200 && higgs_pT < 400 ) && (isGenTauLead_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncUp ;
            if (runTauId.find("TauIdBin_1_Down") != string::npos && (higgs_pT> 200 && higgs_pT < 400 ) && (isGenTauLead_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncDown;
            if (runTauId.find("TauIdBin_2_Up") != string::npos && (higgs_pT> 400 && higgs_pT < 500 ) && (isGenTauLead_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncUp ;
            if (runTauId.find("TauIdBin_2_Down") != string::npos && (higgs_pT> 400 && higgs_pT < 500 ) && (isGenTauLead_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncDown;
            if (runTauId.find("TauIdBin_3_Up") != string::npos && (higgs_pT> 500 && higgs_pT < 700 ) && (isGenTauLead_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncUp ;
            if (runTauId.find("TauIdBin_3_Down") != string::npos && (higgs_pT> 500 && higgs_pT < 700 ) && (isGenTauLead_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncDown;
            if (runTauId.find("TauIdBin_4_Up") != string::npos && (higgs_pT> 700 && higgs_pT < 1000 ) && (isGenTauLead_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncUp ;
            if (runTauId.find("TauIdBin_4_Down") != string::npos && (higgs_pT> 700 && higgs_pT < 1000 ) && (isGenTauLead_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncDown;

            if (runTauId.find("TauIdBin_1_Up") != string::npos && (higgs_pT> 200 && higgs_pT < 400 ) && (isGenTauSub_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncUp ;
            if (runTauId.find("TauIdBin_1_Down") != string::npos && (higgs_pT> 200 && higgs_pT < 400 ) && (isGenTauSub_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncDown;
            if (runTauId.find("TauIdBin_2_Up") != string::npos && (higgs_pT> 400 && higgs_pT < 500 ) && (isGenTauSub_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncUp ;
            if (runTauId.find("TauIdBin_2_Down") != string::npos && (higgs_pT> 400 && higgs_pT < 500 ) && (isGenTauSub_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncDown;
            if (runTauId.find("TauIdBin_3_Up") != string::npos && (higgs_pT> 500 && higgs_pT < 700 ) && (isGenTauSub_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncUp ;
            if (runTauId.find("TauIdBin_3_Down") != string::npos && (higgs_pT> 500 && higgs_pT < 700 ) && (isGenTauSub_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncDown;
            if (runTauId.find("TauIdBin_4_Up") != string::npos && (higgs_pT> 700 && higgs_pT < 1000 ) && (isGenTauSub_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncUp ;
            if (runTauId.find("TauIdBin_4_Down") != string::npos && (higgs_pT> 700 && higgs_pT < 1000 ) && (isGenTauSub_) && (name.find("ZTT")!= string::npos || name.find("TT")!= string::npos || name.find("VV")!= string::npos || name.find("125")!= string::npos || name.find("JJH125")!= string::npos )) weight *= preFitUncDown;
...
//            if (lep2Ptval > 200) lep2Ptval=200;// FIXME for reproducing the preapproval results
            ...
            for (int i =0; i < 3 ;i++) {
                ...
                if (i==0 && NN_out_vec[0] < 0 && NN_out_vec[1] < 0 ) continue;
                if (i==1 && NN_out_vec[0] < 0 && NN_out_vec[1] < 0 ) continue;
                if (i==2 && NN_out_vec[2] < 0 ) continue;
...
//                     if (NN_out_vec[i] > 0.9 && NN_out_vec[i] < 1.0 ) plotFill(name+"_ZPt_NN_p9_p10"+categories.at(i),higgs_pT,20,200,1000,weight);
                    ...
                    if (runPDF){
                        ...
                        if (name.find("TT") != string::npos && name.find("_") == string::npos ){
                            for (int j =0; j < pdfSystWeight->size(); j++){
                                ...
                                plotFill(name+"___"+categories.at(i)+std::to_string(j),higgs_pT ,nbin[i],lowBin,highBin,weight*newWeight);
                ...
                if (OS != 0 && lep1IsoPassV && !lep2IsoPassV ){ // final analysis qcd
                    fillQCD_Norm(i, name, higgs_pT,  weight, frValu2 / (1-frValu2));
//                    fillQCD_Norm(i, name, vbf_var1,  weight, frValu2 / (1-frValu2));
                    fillQCD_Norm_fr_up(i, name, higgs_pT,  weight, frValuUncUp / (1-frValuUncUp));
                    fillQCD_Norm_fr_down(i, name, higgs_pT,  weight, frValuUncDown / (1-frValuUncDown));
                }
                //            qcd shape
//                if (SS != 0 && lep1IsoPassV && !lep2IsoPassV ){ // final analysis
                if (SS != 0 && !lep2IsoPassV ){ // final analysis
                    fillQCD_Shape(i, name, higgs_pT,  weight, frValu2 / (1-frValu2));
//                    fillQCD_Shape(i, name, vbf_var1,  weight, frValu2 / (1-frValu2));
                    fillQCD_Shape_fr_up(i, name, higgs_pT,  weight, frValuUncUp / (1-frValuUncUp));
                    fillQCD_Shape_fr_down(i, name, higgs_pT,  weight, frValuUncDown / (1-frValuUncDown));
                }
            }
            NN_out_vec.clear();
        }
